      ...
      <section id="about" className="about">
        ...
        <div className="about-cards">
          <div className="about-card">
            <h3>👨‍🏫 Teachers</h3>
            <p>Upload, edit and delete notes for every subject.</p>
          </div>

          <div className="about-card">
            <h3>🎓 Students</h3>
            <p>Access and download notes uploaded by teachers.</p>
          </div>

          <div className="about-card">
            <h3>🔒 Secure Portal</h3>
            <p>Separate login portals keep teacher and student data secure.</p>
          </div>
        </div>
      </section>
